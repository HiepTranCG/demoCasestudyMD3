    ...
    public Student findById(int id) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                Clazz clazz = classService.findById(classId); // từ classId vừa lấy được, dùng ClassService để tìm đối tượng class tương ứng
    ...
    public List<Student> findAllByClass(int classId) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                Clazz clazz = classService.findById(clazzId);
                students.add(new Student(id, name, age, clazz));
            }
        } catch (SQLException e) {
        }
